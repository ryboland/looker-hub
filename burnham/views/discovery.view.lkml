...
"
  ...
  dimension: metrics__labeled_counter__test_burnham_space_travel {
    label: "Test Burnham Space Travel"
...
view: discovery__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${discovery.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${discovery.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__discovery__metrics__labeled_counter__glean_error_invalid_label.key
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${discovery.client_info__client_id} end ;;
  }
}

view: discovery__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__glean_error_invalid_overflow
    suggest_dimension: suggest__discovery__metrics__labeled_counter__glean_error_invalid_overflow.key
  }
...
view: discovery__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__glean_error_invalid_state
    suggest_dimension: suggest__discovery__metrics__labeled_counter__glean_error_invalid_state.key
  }
...
view: discovery__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__glean_error_invalid_value
    suggest_dimension: suggest__discovery__metrics__labeled_counter__glean_error_invalid_value.key
  }
...
view: discovery__metrics__labeled_counter__technology_space_travel {
  label: "Technology - Space Travel"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__technology_space_travel
    suggest_dimension: suggest__discovery__metrics__labeled_counter__technology_space_travel.key
  }
...
view: discovery__metrics__labeled_counter__test_burnham_space_travel {
  label: "Test Burnham - Space Travel"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__discovery__metrics__labeled_counter__test_burnham_space_travel
    suggest_dimension: suggest__discovery__metrics__labeled_counter__test_burnham_space_travel.key
  }
...
view: suggest__discovery__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.burnham.discovery as t,
...
view: suggest__discovery__metrics__labeled_counter__glean_error_invalid_overflow {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__discovery__metrics__labeled_counter__glean_error_invalid_state {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__discovery__metrics__labeled_counter__glean_error_invalid_value {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__discovery__metrics__labeled_counter__technology_space_travel {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.burnham.discovery as t,
unnest(metrics.labeled_counter.technology_space_travel) as m
where date(submission_timestamp) > date_sub(current_date, interval 30 day)
    and sample_id = 0
group by key
order by n desc ;;
...
view: suggest__discovery__metrics__labeled_counter__test_burnham_space_travel {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.burnham.discovery as t,
unnest(metrics.labeled_counter.test_burnham_space_travel) as m
where date(submission_timestamp) > date_sub(current_date, interval 30 day)
    and sample_id = 0
group by key
order by n desc ;;
