...
explore: desktop_search_counts {
  ...
  join: search_clients_engines_sources_daily__experiments {
    view_label: "search_clients_engines_sources_daily__experiments"
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_bookmarkmenu_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_bookmarkmenu_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_handoff_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_handoff_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_keywordoffer_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_keywordoffer_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_oneoff_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_oneoff_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_other_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_other_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_shortcut_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_shortcut_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabmenu_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabmenu_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabtosearch_onboard_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabtosearch_onboard_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabtosearch_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_tabtosearch_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_topsites_newtab_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_topsites_newtab_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_topsites_urlbar_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_topsites_urlbar_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_touchbar_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_touchbar_sum"
    relationship: one_to_many
  ...
  join: search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_typed_sum {
    view_label: "search_clients_engines_sources_daily__scalar_parent_urlbar_searchmode_typed_sum"
    relationship: one_to_many
