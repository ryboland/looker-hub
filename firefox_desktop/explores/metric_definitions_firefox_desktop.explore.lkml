...
explore: metric_definitions_firefox_desktop {
  ...
  fields: [
    ...
    -metric_definitions_browser_launched_to_handle_events.submission_date,
    -metric_definitions_browser_launched_to_handle_events.submission_week,
    -metric_definitions_browser_launched_to_handle_events.submission_month,
    -metric_definitions_browser_launched_to_handle_events.submission_quarter,
    -metric_definitions_browser_launched_to_handle_events.submission_year,
    -metric_definitions_browser_launched_to_handle_events.submission_raw,
    -metric_definitions_active_users_aggregates_v1.client_id,
    -metric_definitions_active_users_aggregates_v1.date,
    -metric_definitions_active_users_aggregates_v1.submission_date,
    -metric_definitions_active_users_aggregates_v1.submission_week,
    -metric_definitions_active_users_aggregates_v1.submission_month,
    -metric_definitions_active_users_aggregates_v1.submission_quarter,
    -metric_definitions_active_users_aggregates_v1.submission_year,
    -metric_definitions_active_users_aggregates_v1.submission_raw,
    -metric_definitions_main.client_id,
    -metric_definitions_main.date,
    -metric_definitions_main.submission_date,
    -metric_definitions_main.submission_week,
    -metric_definitions_main.submission_month,
    -metric_definitions_main.submission_quarter,
    -metric_definitions_main.submission_year,
    -metric_definitions_main.submission_raw,
    -metric_definitions_crash.client_id,
    -metric_definitions_crash.date,
    -metric_definitions_crash.submission_date,
    -metric_definitions_crash.submission_week,
    -metric_definitions_crash.submission_month,
    -metric_definitions_crash.submission_quarter,
    -metric_definitions_crash.submission_year,
    -metric_definitions_crash.submission_raw,
    -metric_definitions_events_memory.client_id,
    -metric_definitions_events_memory.date,
    -metric_definitions_events_memory.submission_date,
    -metric_definitions_events_memory.submission_week,
    -metric_definitions_events_memory.submission_month,
    -metric_definitions_events_memory.submission_quarter,
    -metric_definitions_events_memory.submission_year,
    -metric_definitions_events_memory.submission_raw,
    ...
    -metric_definitions_search_clients_engines_sources_daily.submission_date,
    -metric_definitions_search_clients_engines_sources_daily.submission_week,
    -metric_definitions_search_clients_engines_sources_daily.submission_month,
    -metric_definitions_search_clients_engines_sources_daily.submission_quarter,
    -metric_definitions_search_clients_engines_sources_daily.submission_year,
    -metric_definitions_search_clients_engines_sources_daily.submission_raw,
    -metric_definitions_clients_daily.client_id,
    -metric_definitions_clients_daily.date,
    -metric_definitions_clients_daily.submission_date,
    -metric_definitions_clients_daily.submission_week,
    -metric_definitions_clients_daily.submission_month,
    -metric_definitions_clients_daily.submission_quarter,
    -metric_definitions_clients_daily.submission_year,
    -metric_definitions_clients_daily.submission_raw,
    -metric_definitions_events.client_id,
    -metric_definitions_events.date,
    -metric_definitions_events.submission_date,
    -metric_definitions_events.submission_week,
    -metric_definitions_events.submission_month,
    -metric_definitions_events.submission_quarter,
    -metric_definitions_events.submission_year,
    -metric_definitions_events.submission_raw,
    -metric_definitions_newtab_interactions.client_id,
    -metric_definitions_newtab_interactions.date,
    -metric_definitions_newtab_interactions.submission_date,
    -metric_definitions_newtab_interactions.submission_week,
    -metric_definitions_newtab_interactions.submission_month,
    -metric_definitions_newtab_interactions.submission_quarter,
    -metric_definitions_newtab_interactions.submission_year,
    -metric_definitions_newtab_interactions.submission_raw,
    -metric_definitions_normandy_events.client_id,
    -metric_definitions_normandy_events.date,
    -metric_definitions_normandy_events.submission_date,
    -metric_definitions_normandy_events.submission_week,
    -metric_definitions_normandy_events.submission_month,
    -metric_definitions_normandy_events.submission_quarter,
    -metric_definitions_normandy_events.submission_year,
    -metric_definitions_normandy_events.submission_raw,
    -metric_definitions_activity_stream_events.client_id,
    -metric_definitions_activity_stream_events.date,
    -metric_definitions_activity_stream_events.submission_date,
    -metric_definitions_activity_stream_events.submission_week,
    -metric_definitions_activity_stream_events.submission_month,
    -metric_definitions_activity_stream_events.submission_quarter,
    -metric_definitions_activity_stream_events.submission_year,
    -metric_definitions_activity_stream_events.submission_raw,
    -metric_definitions_sponsored_tiles_clients_daily.client_id,
    -metric_definitions_sponsored_tiles_clients_daily.date,
    -metric_definitions_sponsored_tiles_clients_daily.submission_date,
    -metric_definitions_sponsored_tiles_clients_daily.submission_week,
    -metric_definitions_sponsored_tiles_clients_daily.submission_month,
    -metric_definitions_sponsored_tiles_clients_daily.submission_quarter,
    -metric_definitions_sponsored_tiles_clients_daily.submission_year,
    -metric_definitions_sponsored_tiles_clients_daily.submission_raw,
  ]
}