...
explore: metric_definitions_firefox_desktop {
  ...
  fields: [
    date,
    client_id,
    submission_['day', 'week', 'month', 'quarter', 'year', 'raw'],
    ...
    ["-metric_definitions_browser_launched_to_handle_events.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_active_users_aggregates_v1.client_id,
    -metric_definitions_active_users_aggregates_v1.date,
    ["-metric_definitions_active_users_aggregates_v1.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_main.client_id,
    -metric_definitions_main.date,
    ["-metric_definitions_main.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_crash.client_id,
    -metric_definitions_crash.date,
    ["-metric_definitions_crash.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_events_memory.client_id,
    -metric_definitions_events_memory.date,
    ["-metric_definitions_events_memory.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    ...
    ["-metric_definitions_search_clients_engines_sources_daily.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_clients_daily.client_id,
    -metric_definitions_clients_daily.date,
    ["-metric_definitions_clients_daily.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_events.client_id,
    -metric_definitions_events.date,
    ["-metric_definitions_events.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_newtab_interactions.client_id,
    -metric_definitions_newtab_interactions.date,
    ["-metric_definitions_newtab_interactions.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_normandy_events.client_id,
    -metric_definitions_normandy_events.date,
    ["-metric_definitions_normandy_events.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_activity_stream_events.client_id,
    -metric_definitions_activity_stream_events.date,
    ["-metric_definitions_activity_stream_events.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
    -metric_definitions_sponsored_tiles_clients_daily.client_id,
    -metric_definitions_sponsored_tiles_clients_daily.date,
    ["-metric_definitions_sponsored_tiles_clients_daily.submission_['day', 'week', 'month', 'quarter', 'year', 'raw']"],
  ]
}