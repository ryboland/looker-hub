...
explore: client_counts {
  ...
  join: client_counts__contextual_services_quicksuggest_help_sum {
    relationship: one_to_many
  ...
  join: client_counts__contextual_services_quicksuggest_impression_sum {
    relationship: one_to_many
  ...
  join: client_counts__contextual_services_topsites_click_sum {
    relationship: one_to_many
  ...
  join: client_counts__contextual_services_topsites_impression_sum {
    relationship: one_to_many
  ...
  join: client_counts__experiments {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${client_counts.experiments}) AS client_counts__experiments ;;
  }

  join: client_counts__scalar_content_telemetry_event_counts_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_browser_ui_interaction_preferences_pane_home_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_devtools_accessibility_select_accessible_for_node_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_telemetry_event_counts_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_autofill_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_bookmark_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_dynamic_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_extension_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_formhistory_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_history_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_keyword_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_remotetab_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_searchengine_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_searchsuggestion_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_switchtab_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_tabtosearch_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_tip_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_topsite_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_unknown_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_picked_visiturl_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_bookmarkmenu_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_handoff_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_keywordoffer_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_oneoff_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_other_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_shortcut_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_tabmenu_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_tabtosearch_onboard_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_tabtosearch_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_topsites_newtab_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_topsites_urlbar_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_touchbar_sum {
    relationship: one_to_many
  ...
  join: client_counts__scalar_parent_urlbar_searchmode_typed_sum {
    relationship: one_to_many
  ...
  join: client_counts__search_adclicks_urlbar_searchmode_sum {
    relationship: one_to_many
