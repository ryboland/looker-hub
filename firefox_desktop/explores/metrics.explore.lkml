...
explore: metrics {
  ...
  join: metrics__metrics__memory_distribution__fog_ipc_buffer_sizes__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__memory_distribution__fog_ipc_buffer_sizes__values}) AS metrics__metrics__memory_distribution__fog_ipc_buffer_sizes__values ON ${metrics.document_id} = ${metrics__metrics__memory_distribution__fog_ipc_buffer_sizes__values.document_id} ;;
  }
  ...
  join: metrics__metrics__timing_distribution__fog_ipc_flush_durations__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__fog_ipc_flush_durations__values}) AS metrics__metrics__timing_distribution__fog_ipc_flush_durations__values ON ${metrics.document_id} = ${metrics__metrics__timing_distribution__fog_ipc_flush_durations__values.document_id} ;;
  }

  join: metrics__metrics__timing_distribution__paint_build_displaylist_time__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__paint_build_displaylist_time__values}) AS metrics__metrics__timing_distribution__paint_build_displaylist_time__values ON ${metrics.document_id} = ${metrics__metrics__timing_distribution__paint_build_displaylist_time__values.document_id} ;;
  }
