...
SUM(COALESCE(organic_pocket_clicks, 0)) AS organic_pocket_clicks,
SUM(COALESCE(sponsored_pocket_clicks, 0)) AS sponsored_pocket_clicks,
SUM(COALESCE(organic_pocket_impressions, 0)) AS organic_pocket_impressions,
...
base.windows_ubr,
                ...
                metrics.legacy_telemetry_client_id AS client_id,
    ...
    FROM
        mozdata.telemetry.newtab_interactions
            ...
            ON
                ...
                base.client_id = metrics.legacy_telemetry_client_id
