...
ARRAY_AGG(mozfun.hist.extract(payload.histograms.child_process_launch_ms) IGNORE NULLS) AS child_process_launch_ms,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.content_process_count) IGNORE NULLS) AS content_process_count,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.content_process_max) IGNORE NULLS) AS content_process_max,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.checkerboard_severity) IGNORE NULLS) AS checkerboard_severity,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.content_frame_time_vsync) IGNORE NULLS) AS content_frame_time_vsync,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.fx_new_window_ms) IGNORE NULLS) AS fx_new_window_ms,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.fx_tab_switch_composite_e10s_ms) IGNORE NULLS) AS fx_tab_switch_composite_e10s_ms,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.fx_tab_switch_total_e10s_ms) IGNORE NULLS) AS fx_tab_switch_total_e10s_ms,
...
ARRAY_AGG(mozfun.hist.extract(payload.processes.gpu.histograms.keypress_present_latency) IGNORE NULLS) AS keypress_present_latency_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.gpu.histograms.scroll_present_latency) IGNORE NULLS) AS scroll_present_latency,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.memory_total) IGNORE NULLS) AS memory_total,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.cycle_collector_max_pause) IGNORE NULLS) AS cycle_collector_max_pause,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.cycle_collector_max_pause) IGNORE NULLS) AS cycle_collector_max_pause_content,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.cycle_collector_visited_gced) IGNORE NULLS) AS cycle_collector_visited_gced,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.cycle_collector_visited_ref_counted) IGNORE NULLS) AS cycle_collector_visited_ref_counted,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.gc_max_pause_ms_2) IGNORE NULLS) AS gc_max_pause_2,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.gc_max_pause_ms_2) IGNORE NULLS) AS gc_max_pause_2_content,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.gc_ms) IGNORE NULLS) AS gc_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.gc_ms) IGNORE NULLS) AS gc_ms_content,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.gc_slice_during_idle) IGNORE NULLS) AS gc_slice_during_idle,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.gc_slice_during_idle) IGNORE NULLS) AS gc_slice_during_idle_content,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.gc_non_incremental) IGNORE NULLS) AS gc_non_incremental,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.gc_reason_2) IGNORE NULLS) AS gc_reason_2,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.gc_mark_rate_2) IGNORE NULLS) AS gc_mark_rate_2,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.gc_budget_overrun) IGNORE NULLS) AS gc_budget_overrun,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.memory_unique_content_startup) IGNORE NULLS) AS memory_unique_content_startup,
...
ARRAY_AGG(mozfun.hist.extract(payload.histograms.time_to_first_interaction_ms) IGNORE NULLS) AS time_to_first_interaction_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.perf_page_load_time_ms) IGNORE NULLS) AS perf_page_load_time_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.input_event_response_coalesced_ms) IGNORE NULLS) AS input_event_response_coalesced,
ARRAY_AGG(mozfun.hist.extract(payload.processes.gpu.histograms.mouseup_followed_by_click_present_latency) IGNORE NULLS) AS mouseup_followed_by_click_present_latency,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.fx_page_load_ms_2) IGNORE NULLS) AS fx_page_load_ms_2,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.perf_dom_content_loaded_time_ms) IGNORE NULLS) AS perf_dom_content_loaded_time,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.perf_dom_content_loaded_time_from_responsestart_ms) IGNORE NULLS) AS perf_dom_contentperf_dom_content_loaded_time_from_responsestart_ms_loaded_time,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.perf_page_load_time_from_responsestart_ms) IGNORE NULLS) AS perf_page_load_time_from_responsestart,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.perf_request_animation_callback_non_pageload_ms) IGNORE NULLS) AS perf_request_animation_callback_non_pageload,
...
ARRAY_AGG(mozfun.hist.extract(payload.histograms.loaded_tab_count) IGNORE NULLS) AS loaded_tab_count,
...
ARRAY_AGG(mozfun.hist.extract(payload.histograms.tab_unload_to_reload) IGNORE NULLS) AS tab_unload_to_reload,
...
ARRAY_AGG(mozfun.hist.extract(payload.histograms.tab_count) IGNORE NULLS) AS opened_tab_count,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_xdr_encoding_ms) IGNORE NULLS) AS js_pageload_xdr_encoding_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_protect_ms) IGNORE NULLS) AS js_pageload_protect_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_parse_ms) IGNORE NULLS) AS js_pageload_parse_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_execution_ms) IGNORE NULLS) AS js_pageload_execution_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_delazification_ms) IGNORE NULLS) AS js_pageload_delazification_ms,
ARRAY_AGG(mozfun.hist.extract(payload.processes.content.histograms.js_pageload_baseline_compile_ms) IGNORE NULLS) AS js_pageload_baseline_compile_ms,
ARRAY_AGG(mozfun.hist.extract(payload.histograms.input_event_response_ms) IGNORE NULLS) AS input_event_response_ms,
