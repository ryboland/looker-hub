...
view: metric_definitions_focus_android_active_users_view {
  derived_table: {
    sql: SELECT
            ...
            FROM
                (
                    SELECT
                        focus_android_active_users_view.*,
    ...
    WHERE is_mobile
            ...
            ) AS focus_android_active_users_view
        
                    WHERE 
                    focus_android_active_users_view.submission_date
                    BETWEEN
                    COALESCE(
                        SAFE_CAST(
