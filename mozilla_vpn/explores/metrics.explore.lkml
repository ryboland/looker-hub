...
include: "/looker-hub/mozilla_vpn/views/metrics.view.lkml"
...
explore: metrics {
  ...
  join: metrics__metrics__timing_distribution__performance_time_to_main_screen__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__performance_time_to_main_screen__values}) AS metrics__metrics__timing_distribution__performance_time_to_main_screen__values ;;
  }
