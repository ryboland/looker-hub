view: migration {
  ...
  measure: migration_addons_failed_addons_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_addons_failed_addons} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_addons_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_addons_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_addons_migrated_addons_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_addons_migrated_addons} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_addons_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_addons_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_bookmarks_detected_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_bookmarks_detected} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_bookmarks_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_bookmarks_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_bookmarks_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_bookmarks_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_fxa_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_fxa_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_fxa_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_fxa_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_gecko_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_gecko_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_gecko_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_gecko_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_history_detected_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_history_detected} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_history_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_history_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_history_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_history_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_logins_detected_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_logins_detected} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_logins_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_logins_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_logins_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_logins_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_logins_unsupported_db_version_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_logins_unsupported_db_version} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_open_tabs_detected_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_open_tabs_detected} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_open_tabs_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_open_tabs_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_open_tabs_migrated_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_open_tabs_migrated} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_open_tabs_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_open_tabs_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_pinned_sites_detected_pinned_sites_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_pinned_sites_detected_pinned_sites} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_pinned_sites_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_pinned_sites_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_pinned_sites_migrated_pinned_sites_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_pinned_sites_migrated_pinned_sites} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_pinned_sites_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_pinned_sites_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_search_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_search_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_search_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_search_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_settings_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_settings_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_settings_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_settings_success_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_telemetry_identifiers_failure_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_telemetry_identifiers_failure_reason} > 0 then ${client_info__client_id} ;;
  ...
  measure: migration_telemetry_identifiers_success_reason_client_count {
    type: count_distinct
    sql: case when ${metrics__counter__migration_telemetry_identifiers_success_reason} > 0 then ${client_info__client_id} ;;
