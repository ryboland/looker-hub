...
view: logins_sync__metrics__jwe {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: logins_sync__metrics__labeled_rate {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: logins_sync__metrics__labeled_rate__value {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: logins_sync__metrics__text {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: logins_sync__metrics__url {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: suggest__logins_sync__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from moz-fx-data-shared-prod.fenix.logins_sync as t,
