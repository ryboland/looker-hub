...
explore: metrics {
  ...
  join: metrics__metrics__custom_distribution__tab_count_app_backgrounded__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__custom_distribution__tab_count_app_backgrounded__values}) AS metrics__metrics__custom_distribution__tab_count_app_backgrounded__values ;;
  }
