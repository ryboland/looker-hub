include: "/looker-hub/klar_android/views/activation.view.lkml"
...
explore: activation {
  ...
  join: activation__client_info__events__metadata__metrics__jwe__labeled_rate__text {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${activation.client_info__events__metadata__metrics__jwe__labeled_rate__text}) AS activation__client_info__events__metadata__metrics__jwe__labeled_rate__text ON ${activation.document_id} = ${activation__client_info__events__metadata__metrics__jwe__labeled_rate__text.document_id} ;;
  }

  join: activation__client_info__events__metadata__metrics__jwe__labeled_rate__text__url {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${activation.client_info__events__metadata__metrics__jwe__labeled_rate__text__url}) AS activation__client_info__events__metadata__metrics__jwe__labeled_rate__text__url ON ${activation.document_id} = ${activation__client_info__events__metadata__metrics__jwe__labeled_rate__text__url.document_id} ;;
  }
