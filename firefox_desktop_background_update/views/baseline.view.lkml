view: baseline {
  dimension: metrics__timespan__glean_baseline_duration__value {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop_background_update/metrics/glean_baseline_duration"
...
"
  ...
  dimension: metrics__string__glean_baseline_locale {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop_background_update/metrics/glean_baseline_locale"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: suggest__baseline__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from moz-fx-data-shared-prod.firefox_desktop_background_update.baseline as t,
