...
"
  ...
  sql_table_name: `moz-fx-data-shared-prod.firefox_desktop_background_update.background_update` ;;
}
...
view: suggest__background_update__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from moz-fx-data-shared-prod.firefox_desktop_background_update.background_update as t,
