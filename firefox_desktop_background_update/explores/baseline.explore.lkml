include: "/looker-hub/firefox_desktop_background_update/views/baseline.view.lkml"
...
explore: baseline {
  ...
  join: baseline__client_info__events__metadata__metrics__datetime__jwe {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.client_info__events__metadata__metrics__datetime__jwe}) AS baseline__client_info__events__metadata__metrics__datetime__jwe ON ${baseline.document_id} = ${baseline__client_info__events__metadata__metrics__datetime__jwe.document_id} ;;
  }

  join: baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.client_info__events__metadata__metrics__datetime__jwe__labeled_rate}) AS baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate ON ${baseline.document_id} = ${baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate.document_id} ;;
  }

  join: baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__value {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.client_info__events__metadata__metrics__datetime__jwe__labeled_rate__value}) AS baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__value ON ${baseline.document_id} = ${baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__value.document_id} ;;
  }

  join: baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text}) AS baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text ON ${baseline.document_id} = ${baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text.document_id} ;;
  }

  join: baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text__timespan__url {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text__timespan__url}) AS baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text__timespan__url ON ${baseline.document_id} = ${baseline__client_info__events__metadata__metrics__datetime__jwe__labeled_rate__string__text__timespan__url.document_id} ;;
  }
