...
- dashboard: viewpoint_survey_2023_feb_ios
  title: Viewpoint Survey 2023 Feb Ios
  layout: newspaper
  ...
  - title: Memory Total
    ...
    width: 12
    height: 8
    field_x: viewpoint_survey_2023_feb_ios.submission_date
    field_y: viewpoint_survey_2023_feb_ios.point
    log_scale: false
    ci_lower: viewpoint_survey_2023_feb_ios.lower
    ci_upper: viewpoint_survey_2023_feb_ios.upper
    show_grid: true
    listen:
  ...
  - title: Days Of Use
    ...
    filters:
      viewpoint_survey_2023_feb_ios.metric: 'days_of_use'
  ...
  - title: Retained
    ...
    filters:
      viewpoint_survey_2023_feb_ios.metric: 'retained'
      viewpoint_survey_2023_feb_ios.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_survey_2023_feb_ios
    listens_to_filters: []
    field: viewpoint_survey_2023_feb_ios.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_survey_2023_feb_ios
    listens_to_filters: []
    field: viewpoint_survey_2023_feb_ios.parameter
