...
- dashboard: relay_integration_into_firefox_nightly_for_all_fxa_users
  title: Relay Integration Into Firefox Nightly For All Fxa Users
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ...
      relay_integration_into_firefox_nightly_for_all_fxa_users.upper,
      relay_integration_into_firefox_nightly_for_all_fxa_users.lower,
  ...
  - name: Date
    ...
    explore: relay_integration_into_firefox_nightly_for_all_fxa_users
    listens_to_filters: []
    field: relay_integration_into_firefox_nightly_for_all_fxa_users.submission_date
  ...
  - name: Percentile
    ...
    explore: relay_integration_into_firefox_nightly_for_all_fxa_users
    listens_to_filters: []
    field: relay_integration_into_firefox_nightly_for_all_fxa_users.parameter
