...
- dashboard: ios_coordinators_rollout
  title: Ios Coordinators Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ios_coordinators_rollout.submission_date,
      ios_coordinators_rollout.branch,
      ios_coordinators_rollout.upper,
      ios_coordinators_rollout.lower,
      ios_coordinators_rollout.point
    ]
    pivots: [
      ios_coordinators_rollout.branch
    ...
    listen:
      Date: ios_coordinators_rollout.submission_date
      Percentile: ios_coordinators_rollout.parameter
  ...
  - name: Date
    ...
    explore: ios_coordinators_rollout
    listens_to_filters: []
    field: ios_coordinators_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_coordinators_rollout
    listens_to_filters: []
    field: ios_coordinators_rollout.parameter
