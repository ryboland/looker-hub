...
- dashboard: print_background_task_times
  ...
  - title: Print Initiation Counts
    ...
    filters:
      print_background_task_times.metric: '"printing_dialog_opened_via_preview_tm", "printing_dialog_opened_via_preview", "printing_silent_print", "printing_dialog_opened_without_preview", "printing_preview_opened", "printing_preview_opened_tm"'
