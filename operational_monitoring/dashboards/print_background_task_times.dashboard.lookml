...
- dashboard: print_background_task_times
  ...
  - title: Print Cancel Ratios
    ...
    filters:
      print_background_task_times.metric: '"printing_dialog_via_preview_cancelled", "printing_preview_cancelled_tm", "printing_dialog_without_preview_cancelled", "printing_dialog_via_preview_cancelled_tm", "printing_preview_cancelled"'
  ...
  - title: Print Initiation Counts
    ...
    filters:
      print_background_task_times.metric: '"printing_preview_opened", "printing_dialog_opened_via_preview_tm", "printing_silent_print", "printing_dialog_opened_via_preview", "printing_dialog_opened_without_preview", "printing_preview_opened_tm"'
