...
- dashboard: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles
  ...
  - title: Startup Crashes
    ...
    fields: [
      ...
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.point
    ]
    pivots: [
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.branch
    ]
    ...
    field_y: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.point
    log_scale: false
    ci_lower: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.lower
    ci_upper: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.upper
    show_grid: true
    listen:
      Date: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.submission_date
  ...
  - title: Memory Total
    ...
    fields: [
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.submission_date,
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.branch,
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.upper,
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.lower,
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.point
    ]
    pivots: [
      tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.branch
    ...
    listen:
      Date: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.submission_date
      Percentile: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.parameter
  ...
  - name: Date
    ...
    explore: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles
    listens_to_filters: []
    field: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.submission_date
  ...
  - name: Percentile
    ...
    explore: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles
    listens_to_filters: []
    field: tcp_rollout_phase_iii_tcp_on_by_default_for_95_existing_esr_profiles.parameter
