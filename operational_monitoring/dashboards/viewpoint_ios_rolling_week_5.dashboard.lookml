...
- dashboard: viewpoint_ios_rolling_week_5
  title: Viewpoint Ios Rolling Week 5
  layout: newspaper
  ...
  - title: Days Of Use
    ...
    filters:
      viewpoint_ios_rolling_week_5.metric: 'days_of_use'
      viewpoint_ios_rolling_week_5.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      viewpoint_ios_rolling_week_5.metric: 'search_count'
      viewpoint_ios_rolling_week_5.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Memory Total
    ...
    fields: [
      viewpoint_ios_rolling_week_5.submission_date,
      viewpoint_ios_rolling_week_5.branch,
      viewpoint_ios_rolling_week_5.upper,
      viewpoint_ios_rolling_week_5.lower,
      viewpoint_ios_rolling_week_5.point
    ]
    pivots: [
      viewpoint_ios_rolling_week_5.branch
    ...
    listen:
      Date: viewpoint_ios_rolling_week_5.submission_date
      Percentile: viewpoint_ios_rolling_week_5.parameter
  ...
  - name: Date
    ...
    explore: viewpoint_ios_rolling_week_5
    listens_to_filters: []
    field: viewpoint_ios_rolling_week_5.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_ios_rolling_week_5
    listens_to_filters: []
    field: viewpoint_ios_rolling_week_5.parameter
