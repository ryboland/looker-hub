...
- dashboard: nimbus_pref_qa_1_4week_rollout
  title: Nimbus Pref Qa 1 4Week Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      nimbus_pref_qa_1_4week_rollout.submission_date,
      nimbus_pref_qa_1_4week_rollout.branch,
      nimbus_pref_qa_1_4week_rollout.upper,
      nimbus_pref_qa_1_4week_rollout.lower,
      nimbus_pref_qa_1_4week_rollout.point
    ]
    pivots: [
      nimbus_pref_qa_1_4week_rollout.branch
    ...
    listen:
      Date: nimbus_pref_qa_1_4week_rollout.submission_date
      Percentile: nimbus_pref_qa_1_4week_rollout.parameter
  ...
  - name: Date
    ...
    explore: nimbus_pref_qa_1_4week_rollout
    listens_to_filters: []
    field: nimbus_pref_qa_1_4week_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: nimbus_pref_qa_1_4week_rollout
    listens_to_filters: []
    field: nimbus_pref_qa_1_4week_rollout.parameter
