...
- dashboard: ios_tab_refactor_rollout
  title: Ios Tab Refactor Rollout
  layout: newspaper
  ...
  - title: Days Of Use
    ...
    filters:
      ios_tab_refactor_rollout.metric: 'days_of_use'
      ios_tab_refactor_rollout.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: ios_tab_refactor_rollout
    listens_to_filters: []
    field: ios_tab_refactor_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_tab_refactor_rollout
    listens_to_filters: []
    field: ios_tab_refactor_rollout.parameter
