...
view: temp_sync {
  dimension: metrics__labeled_counter__sync_failure_reason {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/sync_failure_reason"
...
view: suggest__temp_sync__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: temp_sync__metrics__labeled_counter__glean_error_invalid_label {
  ...
  dimension: document_id {
    type: string
    sql: ${temp_sync.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${temp_sync.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
...
view: temp_sync__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: temp_sync__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: temp_sync__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: temp_sync__metrics__labeled_counter__sync_failure_reason {
  label: "Sync - Failure Reason"
