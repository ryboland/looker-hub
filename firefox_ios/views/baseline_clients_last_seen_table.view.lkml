view: baseline_clients_last_seen_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "moz-fx-data-shared-prod.firefox_ios.baseline_clients_last_seen"

    allowed_value: {
      label: "Release"
      value: "moz-fx-data-shared-prod.firefox_ios.baseline_clients_last_seen"
    }

    allowed_value: {
      label: "Beta"
      value: "moz-fx-data-shared-prod.org_mozilla_ios_firefoxbeta.baseline_clients_last_seen"
    }

    allowed_value: {
      label: "Nightly"
      value: "moz-fx-data-shared-prod.org_mozilla_ios_fennec.baseline_clients_last_seen"
    }
  }
