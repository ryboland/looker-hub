...
explore: metrics {
  ...
  join: metrics__metrics__timing_distribution__awesomebar_query_time__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__awesomebar_query_time__values}) AS metrics__metrics__timing_distribution__awesomebar_query_time__values ;;
  }
  ...
  join: metrics__metrics__timing_distribution__places_history_migration_duration__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__places_history_migration_duration__values}) AS metrics__metrics__timing_distribution__places_history_migration_duration__values ;;
  }

  join: metrics__metrics__timing_distribution__tabs_tab_switch__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__tabs_tab_switch__values}) AS metrics__metrics__timing_distribution__tabs_tab_switch__values ;;
  }

  join: metrics__metrics__timing_distribution__webview_page_load__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${metrics.metrics__timing_distribution__webview_page_load__values}) AS metrics__metrics__timing_distribution__webview_page_load__values ;;
  }
